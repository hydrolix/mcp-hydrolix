...
DEFAULT_BRAND = "hydrolix"
ENTRY_POINT = "mcp_hydrolix.main:main"
BRAND_ENV_VAR = "MCP_BRAND"

# The single source of brand-divergent metadata. New build-time brand
# customization MUST be added here rather than in sibling configs or CI patches.
BRANDS: dict[str, dict[str, Any]] = {
    ...
    "trafficpeak": {
        ...
        # The Home URL is brand-clean (no "hydrolix"); the Source URL points at
        # the real sibling repo under the hydrolix org -- an accepted exemption
        # to the zero-hydrolix rule for repository-pointing fields.
        "urls": {
...
def rebrand_text(text: str, brand: str) -> str:
    ...
    exempt = ("io.github.hydrolix", "github.com/hydrolix")
    guard = {f"\x00EXEMPT{i}\x00": tok for i, tok in enumerate(exempt)}
