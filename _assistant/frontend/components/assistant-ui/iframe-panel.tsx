...
import {IMPLEMENTATION, SANDBOX_PROXY_URL, ServerInfo, ToolCallInfo} from "@/app/extapps";
import {
    AppBridge,
...
export function IFramePanel({toolCallInfo}: { toolCallInfo: Required<ToolCallInfo> }) {
