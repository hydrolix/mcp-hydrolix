...
class HydrolixConfig:
    ...
    Optional environment variables (with defaults):
        HYDROLIX_PORT: The port number (default: 8443 if secure=True, 8088 if secure=False)
